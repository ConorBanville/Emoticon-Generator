...
{
    internal class LeftEye : IFeature
    {
        public override string Name {get;} // Store the name of the feature, "Left-eye"
        ...
        public override string Embed()
        {
            ...
            {
                return 
$@"<circle cx=""{125 + X}"" cy=""{185 + Y}"" r=""60"" fill=""#F2F2F2"" stroke-width=""0""/>
<circle cx=""{150 + X}"" cy=""{200 + Y}"" r=""18"" fill=""#000000"" stroke-width=""0""/>";
            }
            else
            {
                return
$@"<ellipse cx=""{150 + X}"" cy=""{200 + Y}"" rx=""70"" ry=""40"" fill=""#F2F2F2"" stroke-width=""0""/>
<circle cx=""{150 + X}"" cy=""{221 + Y}"" r=""18"" fill=""#000000"" stroke-width=""0""/>";
            }
        }
